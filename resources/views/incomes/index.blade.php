        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">      
            ...
            <div class="mb-6 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <a href="{{ route('incomes.export') }}" class="inline-flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white px-5 py-3 rounded-lg font-bold transition shadow">
                        Export CSV
                    </a>

                    <form method="POST" action="{{ route('incomes.import') }}" enctype="multipart/form-data" class="flex flex-col gap-2 sm:flex-row sm:items-center">
                        @csrf
