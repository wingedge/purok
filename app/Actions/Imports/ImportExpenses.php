...
final class ImportExpenses
{
    public function execute(string $path, User $creator): ImportResult
    {
        ...
        return DB::transaction(function () use ($rows, $header, $result, $creator): ImportResult {
